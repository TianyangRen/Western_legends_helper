  ...
  locations: [
    ...
    },
    {
      ...
      lines: [
        ...
        "先翻3张公共牌，此时玩家可加注$10/$20，再翻1张公共牌，再次加注，最后翻1张公共牌(庄家永远会跟注)；赢：获所有底注 + 1GP；输：抽1牌（平局则发起者胜）",
        "法罗扑克：使用 1AP，同城镇玩家可加入（参与者均可先获$10），庄家抽取4张战斗牌",
        "玩家依次下注1/2个标记，庄家切1张牌然后翻3张牌，下注第2张的玩家输，下注第3张的玩家赢1倍赌注+1GP，随后玩家可选择撤回标记或留下，下注第4张的玩家赢3倍赌注+1GP"
      ],
      tags: ["酒馆", "扑克", "LP", "通缉"]
    },
    {
      section: "杂货店",
      title: "杂货店",
      lines: ["购买：使用 1AP，购买 / 升级任意数量物品"],
      tags: ["杂货店", "购买", "升级"]
    },
    {
      section: "诊所",
      title: "诊所",
      lines: ["治疗：使用 1AP，支付$10治愈全部伤害；每治愈1点伤害抽1张牌"],
      tags: ["诊所", "治疗", "抽牌"]
    },
    {
      section: "俱乐部",
      title: "俱乐部",
      lines: ["消费：使用 1AP，支付$30获得 1LP，可重复执行"],
      tags: ["俱乐部", "LP"]
    },
    {
      section: "火车",
      title: "火车",
      lines: [
        "劫车（每回合限1次）：使用 1AP，抽1张火车遭遇牌并与列车安保战斗",
